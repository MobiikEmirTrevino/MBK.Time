...
namespace MBK.Time.Web.Mvc.Controllers
{
    ...
    public class HomeController : MBK.Time.Web.Mvc.ControllerBase<ModelBase>
    {
        public HomeController()
        {
            //UIText = new SFSdotNet.Framework.Globalization.TextUI("MBKTime", cmeMeeting.EntityName, GetContextRequest());
        }
        ...
        //    ViewBag.HtmlTabs = SFSdotNet.Framework.Resources.Content.GetContent("MBKTime", "Views/Shared/LeftHomeTabs.cshtml", GetContextRequest());
        ...
        public ActionResult Index()
        {
            ...
            //if (
            //    SFSdotNet.Framework.My.Context.CurrentContext.IsModuleAdmin("MBKTime", SFSdotNet.Framework.My.Context.CurrentContext.Company)
            //    || SFSdotNet.Framework.My.Context.CurrentContext.IsSuperAdmin()
            //    )
            //{
                return RedirectToAction("Statics", "Dashboard", new { area = "SFSdotNetFrameworkSecurity", overrideModule = "MBKTime" });
        ...
        {
            return Content(MBK.Time.Web.Mvc.Resources.ModuleResources.SHORT_DESCRIPTION);
        }
        public ContentResult  LogoUrl()
        {
            return Content(VirtualPathUtility.ToAbsolute("~/MBKTime/Content/img/logo.png"));
        }
